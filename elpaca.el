...
(when (or (eq system-type 'ms-dos) (eq system-type 'windows-nt))
  (setq elpaca-queue-limit 20)) ; This is a balancing act, since if a package has deps higher than the number, emacs will get a memory leak until it crashes or you kill it.
